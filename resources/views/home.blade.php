...
@section('main')
    ...
    <section class="courses-area-three ptb-100 jarallax" data-jarallax='{"speed": 0.3}' style="background-image: unset;background-color:unset">
        <div class="container">
            <div class="section-title white-title">
                <h2>معرض الصور</h2>
            </div>
            @if(count($gallaries) > 3)
            <div class="courses-slider-three owl-theme owl-carousel">
                @include('allgallaries')
            </div>
            @else
                @include('gallaries')
            @endif
